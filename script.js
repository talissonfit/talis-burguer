...
// Fechar o card modal quando clicar fora
...
// Clica no botão Fechar do cart modal
...
function updateCartModal(){
    ...
    cart.forEach(item => {
        ...
        cartItemElemnt.classList.add("flex", "justify-between", "mb-4", "items-center")
